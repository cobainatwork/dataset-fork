    ...
    return (
      ...
      >
        ...
        <Typography color="text.secondary" variant="h6" sx={{ fontWeight: 500 }}>
          {t('blindTest.generatingAnswers', '正在準備題目...')}
        </Typography>
      </Box>
    );
  }
        ...
        <Box sx={{ bgcolor: 'background.default', px: 3, py: 1.5, borderBottom: '1px solid', borderColor: 'divider' }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            <Typography variant="subtitle2" color="text.secondary" sx={{ minWidth: 80, fontWeight: 600 }}>
              {t('blindTest.progress', '進度')} {task.completedCount + 1}/{task.totalCount}
            </Typography>
            <Box sx={{ flex: 1 }}>
              <LinearProgress
                variant="determinate"
              ...
              currentQuestion?.answer ? (
                <Box sx={{ p: 1, maxWidth: 400 }}>
                  ...
                  >
                    ...
                    {t('blindTest.referenceAnswer', '參考答案')}
                  </Typography>
                  <Typography
                    variant="body2"
                ...
                t('blindTest.noReferenceAnswer', '暫無參考答案')
              )
            }
            arrow
            placement="top"
