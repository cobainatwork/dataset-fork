...
/**
 * 通用 dataset 查詢（route 層不直接碰 Prisma 的入口）
 * @param {Object} args - Prisma findMany 引數（where/select...）
 */
export async function findDatasets(args) {
  return await db.datasets.findMany(args);
}
