 ...
 * @property {(id: string, version: number) => Promise<void>} delete - optimistic（version precondition，mismatch 時拋 OptimisticLockError）
 */
 ...
 * @property {(clusterId: string) => Promise<Array<{ id: string, createAt: Date }>>} findClusterMembers - 該 cluster 目前存活的 members（供 removeMember 算 size / promotion）
